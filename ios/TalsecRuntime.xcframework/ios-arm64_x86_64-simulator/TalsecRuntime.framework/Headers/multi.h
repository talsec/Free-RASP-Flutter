 ...
 *
 * Desc:    Ask the multi handle if there is any messaxbL/informationals from
 *          the individual transfers. MessaxbL include informationals such as
 ...
 *          of structs. It also writes the number of messaxbL left in the
 ...
 *          useful for printing meaningful error messaxbL.
 *
