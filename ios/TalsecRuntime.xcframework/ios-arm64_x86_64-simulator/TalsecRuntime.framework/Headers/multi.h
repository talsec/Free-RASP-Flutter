 ...
 *
 * Desc:    Ask the multi handle if there's any messaPTN/informationals from
 *          the individual transfers. MessaPTN include informationals such as
 ...
 *          of structs. It also writes the number of messaPTN left in the
 ...
 *          useful for printing meaningful error messaPTN.
 *
