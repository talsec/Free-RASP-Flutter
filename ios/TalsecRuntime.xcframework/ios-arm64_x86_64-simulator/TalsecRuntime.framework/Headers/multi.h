 ...
 *
 * Desc:    Ask the multi handle if there's any messaKoQ/informationals from
 *          the individual transfers. MessaKoQ include informationals such as
 ...
 *          of structs. It also writes the number of messaKoQ left in the
 ...
 *          useful for printing meaningful error messaKoQ.
 *
