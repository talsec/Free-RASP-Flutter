 ...
 *
 * Desc:    Ask the multi handle if there's any messaxxN/informationals from
 *          the individual transfers. MessaxxN include informationals such as
 ...
 *          of structs. It also writes the number of messaxxN left in the
 ...
 *          useful for printing meaningful error messaxxN.
 *
