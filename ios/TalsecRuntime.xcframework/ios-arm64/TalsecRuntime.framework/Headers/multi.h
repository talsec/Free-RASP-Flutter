 ...
 *
 * Desc:    Ask the multi handle if there is any messarng/informationals from
 *          the individual transfers. Messarng include informationals such as
 ...
 *          of structs. It also writes the number of messarng left in the
 ...
 *          useful for printing meaningful error messarng.
 *
